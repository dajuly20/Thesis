...
\begin{document}
    ...
    \input{./chapter/000_pre/000_Pre.tex}                                           %Titelblatt usw
...
%    \printglossary[type=\acronymtype,style=long,title=Abkürzungsverzeichnis,toctitle=Abkürzungsverzeichnis]
  ...
  %  \pagenumbering{arabic}                                                          %Seitenzahl arabisch
    ...
    \input{./chapter/einleitung/einleitung.tex}
    \input{./chapter/grundlagen/grundlagen.tex}
    \input{./chapter/umsetzung/umsetzung.tex}
    \input{./chapter/auswertung/auswertung.tex}
    %\input{./chapter/ausblick/ausblick.tex}
...
%    \pagenumbering{Alph}                                                            %Seitenzahl aplhanumerisch
        \input{./chapter/anhang/anhang.tex}                                         %Anhang
\end{document}
